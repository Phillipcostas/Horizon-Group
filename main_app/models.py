...
class UserInterest(models.Model):
    ...
    question_1 = models.CharField(
        max_length=255, choices=QUESTION_1_CHOICES, default="Plane", blank=False
    )
    question_2 = models.CharField(
        max_length=255, choices=QUESTION_2_CHOICES, default="Outdoors", blank=False
    )
    question_3 = models.CharField(
        max_length=255, choices=QUESTION_3_CHOICES, default="Local", blank=False
    )
    question_4 = models.CharField(
        max_length=255, choices=QUESTION_4_CHOICES, default="Very Often", blank=False
    )
...
class Invitation(models.Model):
    ...
    invited_user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="trip_invitations"
    )
